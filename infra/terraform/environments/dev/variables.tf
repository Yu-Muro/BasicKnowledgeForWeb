...
variable "hyperdrive_name" {
  description = "Existing dev Hyperdrive configuration name."
  type        = string
}

variable "hyperdrive_origin" {
  description = "Origin connection settings for the existing dev Hyperdrive configuration."
  sensitive   = true
  type = object({
    database             = string
    password             = string
...
variable "hyperdrive_caching" {
  description = "Optional dev Hyperdrive cache settings."
  type = object({
...
variable "hyperdrive_mtls" {
  description = "Optional dev Hyperdrive mTLS settings."
  type = object({
...
variable "hyperdrive_origin_connection_limit" {
  description = "Optional dev Hyperdrive origin connection limit."
  type        = number
  default     = null
}
